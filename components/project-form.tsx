...
export function ProjectForm({
  ...
  const handleFilesSelectedWithLimit = async (selected: File[]) => {
    ...
    const merged = [...files, ...compressed].slice(0, availableSlots);
    if (compressed.length > availableSlots) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const imagesJson =
      existingItems.length > 0
        ? {
            version: 1 as const,
            coverId: coverId ?? existingItems[0]?.mediaId ?? null,
            items: existingItems,
          }
        : ([] as any);
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                {project
                  ? "Modifica los datos del emprendimiento"
                  : "Completa la información del nuevo emprendimiento"}
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Datos principales del emprendimiento
                  </CardDescription>
                </CardHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("price_to", Number(e.target.value))
                        }
                        placeholder="850000"
                        required
                      />
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Información sobre el progreso y estado
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Servicios y comodidades del emprendimiento
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onKeyPress={(e) =>
                        e.key === "Enter" &&
                        (e.preventDefault(), handleAmenityAdd())
                      }
                    />
                    <Button
                      type="button"
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Agrega imágenes del emprendimiento
                </CardDescription>
              </CardHeader>
              <CardContent>
